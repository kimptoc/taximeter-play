...
$c_Lclient_ScalaJSMain$.prototype = new $h_O();
$c_Lclient_ScalaJSMain$.prototype.constructor = $c_Lclient_ScalaJSMain$;
/** @constructor */
function $h_Lclient_ScalaJSMain$() {
  /*<skip>*/
}
$h_Lclient_ScalaJSMain$.prototype = $c_Lclient_ScalaJSMain$.prototype;
$c_Lclient_ScalaJSMain$.prototype.init___ = (function() {
  this.journeyUnderway$1 = false;
  return this
});
$c_Lclient_ScalaJSMain$.prototype.addButton__p1__Lorg_scalajs_dom_raw_Element__T__s_Option__Z__F0__O = (function(main, title, action, enableGPS, body) {
  ...
  startButton.addEventListener("click", (function(action$1, enableGPS$1, body$1) {
    return (function(arg1$2) {
      return $m_Lclient_ScalaJSMain$().client$ScalaJSMain$$$anonfun$addButton$1__Lorg_scalajs_dom_raw_Event__s_Option__Z__F0__O(arg1$2, action$1, enableGPS$1, body$1)
    })
...
$c_Lclient_ScalaJSMain$.prototype.client$ScalaJSMain$$$anonfun$addButton$1__Lorg_scalajs_dom_raw_Event__s_Option__Z__F0__O = (function(e0, action$1, enableGPS$1, body$1) {
  body$1.apply__O();
  if (enableGPS$1) {
    var geo = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().defaultView.navigator.geolocation;
    geo.getCurrentPosition((function(arg1$2) {
      var this$1 = $m_Lclient_ScalaJSMain$();
      this$1.onSuccess$1__p1__Lorg_scalajs_dom_raw_Position__V(arg1$2)
    }));
    var x$1 = (function(arg1$2$1) {
      var this$2 = $m_Lclient_ScalaJSMain$();
      this$2.onSuccess$1__p1__Lorg_scalajs_dom_raw_Position__V(arg1$2$1)
    });
    var x$2 = (function(arg1$2$2) {
...
$c_Lclient_ScalaJSMain$.prototype.sendUpdate__p1__T__V = (function(action) {
  ...
  var url = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["", "/", "/", "/", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([backend_url, action, latitude, longitude]));
...
var $d_Lclient_ScalaJSMain$ = new $TypeData().initClass({
  Lclient_ScalaJSMain$: 0
}, false, "client.ScalaJSMain$", {
  Lclient_ScalaJSMain$: 1,
  O: 1
});
$c_Lclient_ScalaJSMain$.prototype.$classData = $d_Lclient_ScalaJSMain$;
var $n_Lclient_ScalaJSMain$ = (void 0);
function $m_Lclient_ScalaJSMain$() {
  if ((!$n_Lclient_ScalaJSMain$)) {
    $n_Lclient_ScalaJSMain$ = new $c_Lclient_ScalaJSMain$().init___()
  };
  return $n_Lclient_ScalaJSMain$
}
/** @constructor */
